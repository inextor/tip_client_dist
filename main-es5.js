...
module.exports = "<app-navigation></app-navigation>\n<div class=\"nav\" *ngIf=\"is_loading\" class=\"spinner-border text-primary text-align\" role=\"status\">\n  <span class=\"sr-only\">Loading...</span>\n</div>\n<div *ngIf=\"!is_loading && tip_info !== null\">\n\t<app-tip-details [tip_info]=\"tip_info\"></app-tip-details>\n</div>\n<div *ngIf=\"user !== null\" id=\"paypal_button_{{tip_id}}\" class=\"p-3\"></div>\n<div *ngIf=\"user !== null && tip_info !==null && tip_info.tip.price == 0\" class=\"buy_button btn btn-primary text-center p-3\" (click)=\"buyTip()\">BUY</div>\n"
...
module.exports = "<app-navigation></app-navigation>\n\n<div class=\"nav\" *ngIf=\"is_loading\" class=\"spinner-border text-primary text-align\" role=\"status\">\n  <span class=\"sr-only\">Loading...</span>\n</div>\n\n<div *ngIf=\"!is_loading\" class=\"ml-3 mr-3\">\n\t<form action=\"\" method=\"POST\" name=\"add-tip\" ><!-- [formGroup]=\"addTipFormGroup\" -->\n\t\t<img *ngIf=\"sport.image_id !== null\" [src]=\"'/api/image.php?id='+sport.image_id\" class=\"user image profile\">\n\n\t\t<div class=\"form-group\">\n\t\t\t<label>Name</label>\n\t\t\t<input type=\"text\" class=\"form-control\" name=\"sport_name\" [(ngModel)]=\"user.name\" width=\"300\">\n\t\t</div>\n\n\t\t<div class=\"form-group\">\n\t\t\t<label>Profile Image</label>\n\t\t\t<input class=\"form-control\" type=\"file\" (change)=\"onFileSelected($event)\" name=\"image\">\n\t\t</div>\n\t\t<button type=\"button\" class=\"btn btn-primary\" (click)=\"save()\">Save</button>\n\t</form>\n</div>\n"
...
module.exports = "<h2 *ngIf=\"title!=null\">{{title}}</h2>\n\n<div class=\"nav\" *ngIf=\"is_loading\" class=\"spinner-border text-primary text-align\" role=\"status\">\n  <span class=\"sr-only\">Loading...</span>\n</div>\n\n<div class=\"item-table ml-3 mr-3 pt-3 pb-3\" *ngIf=\"tips.length d-flex\">\n\t<div  *ngFor=\"let tip_info of tips\" class=\"d-flex justify-content-between item-component\">\t\n\n\t\t<div class=\"user_content\">\n\t\t  <div class=\"user_logo big\">\n\t\t\t  <img *ngIf=\"tip_info.user.image_id !== null\" [src]=\"'/api/image.php?id='+tip_info.user.image_id\"  alt=\"{{tip_info.user.name}} image\">\n\t\t\t  <img *ngIf=\"tip_info.user.image_id == null\" src=\"/assets/user.svg\" [alt]=\"tip_info.user.name+'image'\">\n\t\t  </div>\n\t\t  <div class=\"user_name\"> {{tip_info.user.name}}</div>\n\t\t  <div class=\"user_stats\" *ngIf=\"tip_info.user_stats!=null\">{{tip_info.user_stats.correct_tips}}/{{tip_info.user_stats.total_reviewed_tips}}</div>\n\t\t  <div class=\"user_stats\" *ngIf=\"tip_info.user_stats==null\"><div class=\"badge badge-info\">New</div></div>\n\t\t</div>\n\n\t\t<div class=\"flex-fill middle-section\">\n\n  \t  \t  <div class=\"align-self-center d-flex team-info\">\n\t  \t  \t<div class=\"left-team flex-fill text-center\">\n\t  \t  \t\t<img *ngIf=\"tip_info.left_team != null && tip_info.left_team.image_id !=null && tip_info.right_team !=null && tip_info.right_team.image_id !=null \" [src]=\"'/api/image.php?id='+tip_info.left_team.image_id\" class=\"logo left\">\n\t  \t  \t\t<br>\n  \t  \t  \t\t<span *ngIf=\"tip_info.tip.custom_left_team\" class=\"team_name\">{{tip_info.tip.custom_left_team}}</span>\n  \t  \t  \t\t<span *ngIf=\"tip_info.left_team!==null\" class=\"team_name\">{{tip_info.left_team.name}}</span>\n\t  \t  \t</div>\n\t  \t  \t<div class=\"flex-fill text-center\">vs</div>\n\t  \t   \t<div class=\"flex-fill right-team text-center\">\n\t  \t  \t\t<img *ngIf=\"tip_info.left_team != null && tip_info.left_team.image_id !=null && tip_info.right_team !=null && tip_info.right_team.image_id !=null \" [src]=\"'/api/image.php?id='+tip_info.right_team.image_id\" class=\"logo right\">\n\t  \t  \t\t<br>\n\t  \t  \t\t<span *ngIf=\"tip_info.left_team!==null\" class=\"team_name\">{{tip_info.right_team.name}}</span> \n  \t  \t \t\t<span *ngIf=\"tip_info.tip.custom_left_team\" class=\"team_name\">{{tip_info.tip.custom_right_team}}</span>\n\t  \t  \t</div>\n  \t  \t  </div>\n\t  \t  <div class=\"date\">\n  \t  \t\t<span> {{tip_info.tip.event_start |date :'MMM/dd h:mm a'}}</span>\n\t  \t  \t<a *ngIf=\"tip_info.league !== null\" class=\"badge badge-info\" [routerLink]=\"['/league/',tip_info.league.id]\">\n  \t  \t  \t\t {{tip_info.league.name}}\n  \t  \t  \t</a>\n\t  \t  </div>\n  \t  \t</div>\n\t  <!--   -->\n  \t  <div class=\"justify-content-end align-self-center\">\n  \t  \t<div class=\"align-self-center buy\">\n\t\t\t\t<div><a [routerLink]=\"['/buy', tip_info.tip.id]\" class=\"car\"><img src=\"/assets/cart64.png\" alt=\"buy\"></a></div>\n\t\t\t\t<div *ngIf=\"tip_info.tip.price>0\" >{{tip_info.tip.price| currency}}</div>\n\t\t\t\t<div *ngIf=\"tip_info.tip.price==0\">FREE</div>\n  \t  \t</div>\n  \t  </div>\n  \t</div>\n</div>\n\n<div *ngIf=\"tips.length == 0 \">\n\t<div class=\"card\">\n\t  <div class=\"card-body\">\n\t    No Tips Found\n\t  </div>\n\t</div>\n</div>\n"
...
module.exports = "<app-navigation></app-navigation>\n<div class=\"nav\" *ngIf=\"is_loading\" class=\"spinner-border text-primary text-align\" role=\"status\">\n  <span class=\"sr-only\">Loading...</span>\n</div>\n\n<div *ngIf=\"tip_info==null && !is_loading\">\n\t\tError try again later\n</div>\n<div *ngIf=\"tip_info!==null\">\n\t<app-tip-details [tip_info]=\"tip_info\"></app-tip-details>\n\t<div *ngIf=\"tip_info.tip.media1_image_id!==null\">\n\t  <img [src]=\"'/api/image.php?id='+tip_info.tip.media1_image_id\" width=\"300\">\n\t  <a  target=\"_BLANK\" href=\"/api/image.php?id={{tip_info.tip.media1_image_id}}&download=1\">Download</a>\n\t</div>\n</div>\n"
...
var AddLeagueComponent = /** @class */ (function () {
    function AddLeagueComponent(restService) {
    ...
    AddLeagueComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.restService.getSports().subscribe(function (sports) {
            _this.sports = sports;
        });
    };
    AddLeagueComponent.prototype.saveLeague = function () {
        this.restService.addLeague(this.league).subscribe(function (league) {
        });
    };
    AddLeagueComponent.prototype.onFileSelected = function (event) {
        this.selectedFile = event.target.files[0];
        this.onUpload();
    };
    AddLeagueComponent.prototype.onUpload = function () {
        var _this = this;
        this.restService.uploadImage(this.selectedFile, false).subscribe(function (image) {
            _this.league.image_id = image.id;
        });
    };
...
var AddSportComponent = /** @class */ (function () {
    function AddSportComponent(restService) {
        this.restService = restService;
        this.name = '';
    }
    AddSportComponent.prototype.ngOnInit = function () {
    };
    AddSportComponent.prototype.onCreateSport = function () {
        this.restService.addSport({ name: this.name }).subscribe(function (sport) {
...
var AddTeamComponent = /** @class */ (function () {
    function AddTeamComponent(restService) {
        this.restService = restService;
    ...
    AddTeamComponent.prototype.onSaveTeam = function () {
        this.restService.addTeam(this.team).subscribe(function (team) {
        });
    };
    ...
    AddTeamComponent.prototype.onUpload = function () {
        var _this = this;
        this.restService.uploadImage(this.selectedFile, false).subscribe(function (image) {
            _this.image = image;
            _this.team.image_id = image.id;
        });
    };
...
var AddTipComponent = /** @class */ (function () {
    function AddTipComponent(tipService, router) {
    ...
    AddTipComponent.prototype.ngOnInit = function () {
        var _this = this;
        var user = this.tipService.getCurrentUser();
        if (user == null) {
            this.router.navigate(['/']);
            console.log("IS NULL");
        }
        else {
            this.tipService.getSports().subscribe(function (sports) { return _this.sports = sports; });
        }
    };
    AddTipComponent.prototype.onSportChange = function (sport_id) {
        var _this = this;
        if (sport_id == '') {
            this.leagues = [];
            this.teams = [];
            ...
            this.tipService.getLeagues(sport_id).subscribe(function (leagues) {
                _this.leagues = leagues;
                if (_this.leagues.length == 0) {
                    _this.teams = [];
                    _this.tip.left_team_id = 0;
                    _this.tip.right_team_id = 0;
                    _this.tip.result = 'CUSTOM';
                }
            });
        }
    };
    AddTipComponent.prototype.onLeagueChange = function (league_id) {
        var _this = this;
        this.tipService.getTeams(league_id).subscribe(function (teams) {
            teams.unshift({
                id: 0,
                sport_id: '',
                name: 'Select One'
    ...
    AddTipComponent.prototype.onLeftTeamChange = function (left_team_id) {
        this.tip.left_team_id = left_team_id;
    };
    AddTipComponent.prototype.onRightTeamChange = function (right_team_id) {
        this.tip.right_team_id = right_team_id;
    };
    AddTipComponent.prototype.onSaveTip = function () {
        var _this = this;
        this.tipService.saveTip(this.tip).subscribe(function (tip) {
            console.log("Saved tip");
            console.log("TIp", tip);
            _this.router.navigate(['/view-tip', tip.id]);
        });
    };
    AddTipComponent.prototype.onBetTypeChange = function (bet_type) {
        console.log(bet_type);
        this.bet_type_options = this.results_types[bet_type];
        console.log(this.bet_type_options);
    };
    AddTipComponent.prototype.onBetResultChange = function (result) {
        console.log("Result is now", result);
        this.tip.result = result;
        console.log("tip is now", this.tip);
    };
    AddTipComponent.prototype.onFileSelected = function (event) {
        this.selectedFile = event.target.files[0];
        this.onUpload();
    };
    AddTipComponent.prototype.onEventStartChange = function (value) {
        var d = new Date(value);
        console.log("Date set", d);
        this.tip.event_start = d;
    };
    AddTipComponent.prototype.onUpload = function () {
        var _this = this;
        this.tipService.uploadImage(this.selectedFile, true).subscribe(function (image) {
            _this.tip.media1_image_id = image.id;
        });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostBinding"])('class'),
...
//#endregion
var BuyTipComponent = /** @class */ (function () {
    function BuyTipComponent(restService, router, route) {
        this.restService = restService;
        this.router = router;
        this.route = route;
    ...
    BuyTipComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (paramMap) {
            console.log("FOOO");
            _this.tip_id = paramMap.get('tip_id') != null ? parseInt(paramMap.get('tip_id')) : 0;
            return _this.restService.getUser('me').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["of"])(null);
            }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (user) {
            if (user == null) {
                _this.router.navigate(['/login-redirect', _this.tip_id]);
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(null);
            }
            console.log("GETTING tip info");
            return _this.restService.getTipInfo(_this.tip_id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                console.log("erro on getTipInfo", error);
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(null);
            }));
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (tip_infos) {
            console.log("FIltering tip_info", tip_infos);
            return tip_infos !== null;
        }))
            .subscribe(function (tip_infos) {
            console.log("ON SUBSCRIBER", tip_infos);
            _this.is_loading = false;
            _this.tip_info = tip_infos[0];
            var date = null;
            var zero = function (z) {
                if (z < 0)
                    return '0' + z;
            ...
            var date_str = '';
            var tipDate = new Date(_this.tip_info.tip.event_start);
            var currentDate = new Date();
            if ('bought' in _this.tip_info && _this.tip_info.bought == 1) {
                console.log("Tip is bought");
                _this.router.navigate(['/view-tip/', _this.tip_info.tip.id]);
            }
            else if (_this.tip_info.tip.price == 0) {
                console.log("Price is 0 do nothing");
            }
            else if (tipDate > currentDate) {
                renderPaypalButton2(_models_tips__WEBPACK_IMPORTED_MODULE_6__["site_settings"].url_base, _this.tip_info.tip);
            }
    ...
    BuyTipComponent.prototype.buyTip = function () {
        var _this = this;
        this.restService.buyFreeTip(this.tip_id).subscribe(function (tip) {
            _this.router.navigate(['/view-tip/', _this.tip_id]);
        });
    };
...
var EditLeagueComponent = /** @class */ (function () {
    function EditLeagueComponent(restService, router, route) {
        this.restService = restService;
        this.router = router;
        this.route = route;
        this.league = null;
    ...
    EditLeagueComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (params) {
            console.log(params);
            var league_id = parseInt(params.get('league_id'));
            _this.restService.getTeams(league_id).subscribe(function (teams) {
                _this.teams = teams;
            });
            return _this.restService.getLeague(league_id);
    ...
    EditLeagueComponent.prototype.updateLeague = function () {
        var _this = this;
        this.restService.updateLeague(this.league).subscribe(function (league) {
            _this.success = "league data updated";
            setTimeout(function () {
                _this.league = league;
                _this.success = null;
            }, 1500);
    ...
    EditLeagueComponent.prototype.onFileSelected = function (event) {
        this.selectedFile = event.target.files[0];
        this.onUpload();
    };
    EditLeagueComponent.prototype.onUpload = function () {
        var _this = this;
        this.restService.uploadImage(this.selectedFile, false).subscribe(function (image) {
            _this.league.image_id = image.id;
        });
...
var EditLeaguesComponent = /** @class */ (function () {
    function EditLeaguesComponent(restService, router, route) {
        this.restService = restService;
        this.router = router;
        this.route = route;
    ...
    EditLeaguesComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    EditLeaguesComponent.prototype.onSportChange = function (sport_id) {
        var _this = this;
        this.is_loading = true;
        this.sport_id = sport_id;
        this.restService.getLeagues(sport_id).subscribe(function (leagues) {
            _this.leagues = leagues;
            _this.is_loading = false;
        });
    };
...
var EditProfileComponent = /** @class */ (function () {
    function EditProfileComponent(restService) {
        this.restService = restService;
        this.is_loading = true;
        this.selectedFile = null;
        this.user = null;
    ...
    EditProfileComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.restService.getUser('me').subscribe(function (user) {
            _this.user = user;
            _this.is_loading = false;
        });
    };
    EditProfileComponent.prototype.save = function () {
        var _this = this;
        this.restService.updateUser(this.user).subscribe(function (user) {
            _this.user = user;
        });
    };
    EditProfileComponent.prototype.onFileSelected = function (event) {
        this.selectedFile = event.target.files[0];
        this.onUpload();
    };
...
var EditSportComponent = /** @class */ (function () {
    function EditSportComponent(restService, router, route, location) {
        this.restService = restService;
        this.router = router;
        this.route = route;
    ...
    EditSportComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (params) {
            var sport_id = parseInt(params.get('sport_id'));
            return _this.restService.getSport(sport_id);
        }))
    ...
    EditSportComponent.prototype.save = function () {
        var _this = this;
        this.restService.updateSport(this.sport).subscribe(function (sport) {
            setTimeout(function () {
                _this.location.back();
            }, 1500);
        });
    };
    EditSportComponent.prototype.onFileSelected = function (event) {
        this.selectedFile = event.target.files[0];
        this.onUpload();
    };
    EditSportComponent.prototype.onUpload = function () {
        var _this = this;
        this.restService.uploadImage(this.selectedFile, false).subscribe(function (image) {
            _this.sport.image_id = image.id;
        });
    };
...
var EditTeamComponent = /** @class */ (function () {
    function EditTeamComponent(restService, router, route, location) {
        this.restService = restService;
        this.router = router;
        this.route = route;
        this.location = location;
    ...
    EditTeamComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["switchMap"])(function (params) {
            console.log(params);
            var team_id = params.get('team_id') != null ? parseInt(params.get('team_id')) : null;
            return _this.restService.getTeam(team_id);
        })).subscribe(function (team) {
            _this.is_loading = false;
            _this.team = team;
        });
    };
    EditTeamComponent.prototype.onSaveTeam = function () {
        var _this = this;
        this.restService.updateTeam(this.team).subscribe(function (team) {
            setTimeout(function () {
                _this.location.back();
            }, 1500);
        });
    };
    EditTeamComponent.prototype.onFileSelected = function (event) {
        this.selectedFile = event.target.files[0];
        this.onUpload();
    };
    EditTeamComponent.prototype.onUpload = function () {
        var _this = this;
        this.restService.uploadImage(this.selectedFile, false).subscribe(function (image) {
            _this.team.image_id = image.id;
        });
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(restService, router, activeRoute) {
        this.restService = restService;
        this.router = router;
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        this.activeRoute.paramMap.subscribe(function (paramMap) {
            ...
            if (paramMap.get('tip_id')) {
                _this.tip_id = paramMap.get('tip_id');
            }
            _this.restService.getUser('me').subscribe(function (user) {
                _this.doNavigate();
            });
        });
    };
    LoginComponent.prototype.doNavigate = function () {
        if (this.tip_id === null) {
    ...
    LoginComponent.prototype.doLogin = function () {
        var _this = this;
        this.restService.doLogin(this.email, this.password).subscribe(function (user) {
            _this.doNavigate();
...
var LogoutComponent = /** @class */ (function () {
    function LogoutComponent(restService, router) {
        this.restService = restService;
        this.router = router;
    }
    LogoutComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.restService.logout().subscribe(function (result) {
...
var MyTipsComponent = /** @class */ (function () {
    function MyTipsComponent() {
        this.my_tips_search = {
            title: 'My Tips',
            authorized: true
        };
    }
    MyTipsComponent.prototype.ngOnInit = function () {
    };
...
module.exports = ".dark\n{\n\tbackground-color: #212121;\n\tcolor: white;\n\theight: 50px;\n\tpadding: 0;\n}\n\n.dark a\n{\n  color: white;\n  font-size: 25px;\n  line-height: 50px;\n}\n\n.sports\n{\n   margin: 20px;\n}\n\n.dark a\n{\n\tpadding: 0 15px;\n}\n\n.main_logo\n{\n\twidth: 60px;\n}\n\n.nav-link\n{\n\tpadding: 5px;\n}\n\n.sport_logo\n{\n   width: 35px;\t\n}\n\n.sport-link\n{\n   color: gray;\n   font-weight: bolder;\n}\n\n.desktop\n{\n   display: none;\n}\n\n@media (min-width:750px )\n{\n\t.desktop\n\t{\n\t\tdisplay: initial;\n\t}\n}\n\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var NavigationComponent = /** @class */ (function () {
    function NavigationComponent(restService, router, route) {
        this.restService = restService;
        this.router = router;
        this.route = route;
        this.sport_list = [];
    ...
    NavigationComponent.prototype.ngOnInit = function () {
        ...
        this.restService.getSports().subscribe(function (sports) { return _this.sport_list = sports; });
...
var ReviewTipListComponent = /** @class */ (function () {
    function ReviewTipListComponent(tipService) {
        this.tipService = tipService;
        this.tips = [];
        this.dateFilter = '';
        this.event_start = '';
    }
    ReviewTipListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.tipService.getTipsInfoPending().subscribe(function (tip_infos) { return _this.tips = tip_infos; });
    };
    ReviewTipListComponent.prototype.onChangeFilter = function (value) {
        var _this = this;
        ...
        switch (value) {
            case 'PENDING':
                ...
                break;
            case 'EVENT_DATE':
                this.tipService.getTipsInfoByEventDate(date_str).subscribe(function (tip_infos) { return _this.tips = tip_infos; });
                break;
...
var ReviewTipComponent = /** @class */ (function () {
    function ReviewTipComponent(restService) {
        this.restService = restService;
    }
    ReviewTipComponent.prototype.ngOnInit = function () {
    };
    ReviewTipComponent.prototype.onChangePredictionStatus = function (value) {
        var _this = this;
        this.restService.updateTip({ id: this.tip_info.tip.id, prediction_status: value }).subscribe(function (result) {
            _this.tip_info.tip.prediction_status = value;
        });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var ReviewTipsComponent = /** @class */ (function () {
    function ReviewTipsComponent() {
    }
    ReviewTipsComponent.prototype.ngOnInit = function () {
    };
...
var SearchLeagueComponent = /** @class */ (function () {
    function SearchLeagueComponent() {
    }
    SearchLeagueComponent.prototype.ngOnInit = function () {
    };
...
var SearchComponent = /** @class */ (function () {
    function SearchComponent(restService, router, route) {
        this.restService = restService;
        this.router = router;
        this.route = route;
        this.settings = _models_tips__WEBPACK_IMPORTED_MODULE_5__["site_settings"];
    ...
    SearchComponent.prototype.ngOnInit = function () {
        ...
        this.restService.getSports().subscribe(function (sports) { return _this.sport_list = sports; });
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (params) {
            _this.user_id = params.get('user_id') != null ? parseInt(params.get('user_id')) : null;
            _this.sport_id = params.get('sport_id');
            _this.team_id = params.get('team_id') != null ? parseInt(params.get('team_id')) : null;
            _this.league_id = params.get('league_id') !== null ? parseInt(params.get('league_id')) : null;
            _this.team_name = params.get('team_name');
            if (_this.sport_id) {
                _this.restService.getLeagues(_this.sport_id).subscribe(function (leagues) {
                    _this.league_list = leagues.filter(function (i, index) { return index < 4; });
                });
            }
            return _this.restService.search(_this.user_id, _this.sport_id, _this.team_id, _this.league_id, _this.team_name, _this.restService.getCurrentDateString(), false);
        })).subscribe(function (tip_infos) {
            _this.tips = tip_infos;
            _this.is_loading = false;
            console.log(_this.tips);
            console.log("Is loading false");
        });
    };
    SearchComponent.prototype.onChangeSport = function (sport_id) {
        var _this = this;
        this.is_loading = true;
        this.sport_id = sport_id;
        this.restService.getLeagues(sport_id).subscribe(function (leagues) { return _this.league_list = leagues.filter(function (l, i) { return i < 4; }); });
        this.league_id = null;
        this.restService.search(this.user_id, this.sport_id, this.team_id, this.league_id, this.team_name, this.restService.getCurrentDateString(), false).subscribe(function (tip_infos) {
            _this.tips = tip_infos;
            _this.is_loading = false;
            console.log("tips has now", _this.tips);
            console.log("Is loading false");
            console.log(_this.tips);
        });
    };
    SearchComponent.prototype.onChangeLeague = function (league_id) {
        var _this = this;
...
var SignupComponent = /** @class */ (function () {
    function SignupComponent(tipService, router) {
        this.tipService = tipService;
        this.router = router;
        this.classes = 'create';
        this.name = '';
    ...
    SignupComponent.prototype.createAccount = function () {
        var _this = this;
        this.tipService.createAccount({ name: this.name, email: this.email, password: this.password, password_confirmation: this.password_confirmation, type: 'TIPSTER' }).subscribe(function (user) {
            _this.router.navigate(['/my-tips']);
        });
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["HostBinding"])('class'),
...
module.exports = ".logo.left\n,.logo.right\n{\n\twidth: 110px;\n}\n\n\n.prediction_status\n{\n    font-size: 40px;\n    color: goldenrod;\n\ttext-align: center;\n\tmargin-top: 30px;\n\tmargin-bottom: 30px;\n}\n\n\n.text-small\n{\n\tfont-size: 9px;\n}\n\n\n.text-big\n{\n\tfont-size: 30px;\n\tfont-weight: bold;\n}\n\n\n.user_logo img\n{\n\twidth: 50px;\n\theight: 50px;\n}\n\n\n.result\n{\n\tfont-weight: bold;\n\tfont-size: 20px;\n}\n\n\n.details\n{\n\tmargin: 20px auto;\n}\n\n\n.user-row\n{\n}\n\n\n.twitter\n{\n\tmargin: 30px auto;\n\tdisplay: inline-block;\n\twidth: 100%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var TipDetailsComponent = /** @class */ (function () {
    function TipDetailsComponent() {
        this.settings = _models_tips__WEBPACK_IMPORTED_MODULE_2__["site_settings"];
    }
    TipDetailsComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object)
...
var TipsListComponent = /** @class */ (function () {
    function TipsListComponent(restService) {
        this.restService = restService;
        this.is_loading = true;
        this.tips = [];
        this.settings = _models_tips__WEBPACK_IMPORTED_MODULE_3__["site_settings"];
    ...
    Object.defineProperty(TipsListComponent.prototype, "search", {
        set: function (search) {
            var _this = this;
            this.title = search.title ? search.title : '';
            this.restService.makeSearch(search).subscribe(function (tips_info) {
                _this.is_loading = false;
                _this.tips = tips_info;
            });
        },
        enumerable: true,
        configurable: true
    });
    TipsListComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Object),
...
var TipsterOffersComponent = /** @class */ (function () {
    function TipsterOffersComponent(restService, router) {
        this.restService = restService;
        this.router = router;
        this.tip_infos = [];
    }
    TipsterOffersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.restService.makeSearch({ event_start: this.restService.getCurrentDateString(), authorized: false }).subscribe(function (tip_infos) { return _this.tip_infos = tip_infos; });
    };
...
//#endregion
var UpgradeProComponent = /** @class */ (function () {
    function UpgradeProComponent(restService) {
        this.restService = restService;
        this.user = null;
        this.is_loading = true;
    }
    UpgradeProComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.restService.getUser('me').subscribe(function (user) {
            _this.user = user;
...
var UserSettingsComponent = /** @class */ (function () {
    function UserSettingsComponent(restService, router) {
        this.restService = restService;
        this.router = router;
        this.user = null;
        this.is_loading = true;
...
var ViewTipComponent = /** @class */ (function () {
    function ViewTipComponent(restService, router, route) {
        this.restService = restService;
        this.router = router;
        this.route = route;
        this.settings = _models_tips__WEBPACK_IMPORTED_MODULE_5__["site_settings"];
    ...
    ViewTipComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (params) {
            console.log(params);
            var tip_id = params.get('tip_id') != null ? parseInt(params.get('tip_id')) : null;
            return _this.restService.getTipInfo(tip_id);
        })).subscribe(function (tip_infos) {
...
var TipRestService = /** @class */ (function () {
    function TipRestService(http) {
        this.http = http;
    ...
    TipRestService.prototype.addSport = function (sport) {
        return this.http.post(this.urlBase + "/sport.php", sport, { withCredentials: true });
    };
    TipRestService.prototype.buyFreeTip = function (tip_id) {
        return this.http.post(this.urlBase + "/buy.php", { tip_id: tip_id }, { withCredentials: true });
    };
    TipRestService.prototype.getSports = function () {
        return this.http.get(this.urlBase + "/sport.php");
    };
    TipRestService.prototype.getSport = function (sport_id) {
        return this.http.get(this.urlBase + "/sport.php?id=" + sport_id);
    };
    TipRestService.prototype.buy_tip = function (tip_id) {
        return this.http.get(this.urlBase + "/buy.php?tip_id=" + tip_id, { withCredentials: true });
    };
    TipRestService.prototype.getCurrentUser = function () {
        return this.user;
    };
    TipRestService.prototype.getUser = function (user_id) {
        var _this = this;
        var result = this.http.get(this.urlBase + "/user.php?id=" + user_id, { withCredentials: true });
    ...
    TipRestService.prototype.doLogin = function (email, password) {
        var _this = this;
        var result = this.http.post(this.urlBase + "/login.php", { email: email, password: password }, { withCredentials: true });
        result.subscribe(function (user) {
            _this.user = user;
        });
        return result;
    };
    TipRestService.prototype.logout = function () {
        var _this = this;
        console.log("Login out");
        var result = this.http.get(this.urlBase + "/logout.php", { withCredentials: true });
        result.subscribe(function (result) {
            _this.user = null;
        });
        return result;
    };
    TipRestService.prototype.updateUser = function (user) {
        return this.http.put(this.urlBase + "/user.php", user, { withCredentials: true });
    };
    TipRestService.prototype.makeSearch = function (search) {
        ...
        var authorized = 'authorized' in search ? search.authorized : false;
    ...
    TipRestService.prototype.search = function (user_id, sport_id, team_id, league_id, team_name, start, authorized) {
    ...
    TipRestService.prototype.getTipInfo = function (tip_id) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        params = params.append('tip_id', tip_id);
        return this.http.get(this.urlBase + "/tip_info.php", { params: params, withCredentials: true });
    };
    TipRestService.prototype.getTipsInfoByIds = function (tip_ids) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        params = params.append('tip_id', tip_ids.join(','));
        return this.http.get(this.urlBase + "/tip_info.php", { params: params, withCredentials: true });
    };
    TipRestService.prototype.getCurrentDateString = function () {
        var zero = function (z) {
            if (z < 10)
                return '0' + z;
            return '' + z;
    ...
    TipRestService.prototype.getTipInfoNexts = function () {
        return this.getTipsInfoByEventDate(this.getCurrentDateString());
    };
    TipRestService.prototype.getTipsInfoByEventDate = function (date) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        params = params.append('event_start', date);
        return this.http.get(this.urlBase + "/tip_info.php", { params: params, withCredentials: true });
    };
    TipRestService.prototype.getTipsInfoPending = function () {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]();
        params = params.append('prediction_status', 'PENDING');
        return this.http.get(this.urlBase + "/tip_info.php", { params: params, withCredentials: true });
    };
    TipRestService.prototype.getTipsInfo = function () {
        return this.http.get(this.urlBase + "/tip_info.php", { withCredentials: true });
    };
    TipRestService.prototype.createAccount = function (user) {
        return this.http.post(this.urlBase + "/user.php", user, { withCredentials: true });
    };
    TipRestService.prototype.uploadImage = function (file, is_private) {
        var fd = new FormData();
